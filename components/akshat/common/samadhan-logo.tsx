...
export function SamadhanLogoIcon({ size = 48, className = "" }: SamadhanLogoIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <polygon points="50,11 86,22 50,33 14,22" fill="#0D9488" />
      <path d="M 28,27.5 L 28,34 C 28,40 72,40 72,34 L 72,27.5" fill="#0B7268" />
      ...
      <path d="M 50,52 C 45.5,58 44,70 50,86 C 56,70 54.5,58 50,52 Z" fill="#0D9488" />
      <path d="M 44,57 C 38,62 38,72 48,84 C 42,75 40,64 44,57 Z" fill="#0F766E" />
      <path d="M 56,57 C 62,62 62,72 52,84 C 58,75 60,64 56,57 Z" fill="#0F766E" />
      <path d="M 23,56 C 26,67 36,80 47,87 C 37,81 29,71 23,56 Z" fill="#0D9488" />
      <path d="M 77,56 C 74,67 64,80 53,87 C 63,81 71,71 77,56 Z" fill="#0D9488" />
      <path
