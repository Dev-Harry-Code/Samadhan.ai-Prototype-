...
export const FUNDERS: Funder[] = [
  ...
  },
  {
    ...
    kind: "CSR Foundation",
    fundedProjects: 22,
    focus: "Healthcare & water in Jharkhand",
  },
  {
    id: "lokpump",
...
export const FLAGSHIP_ISSUE: Issue = {
  ...
  location: {
    lat: 26.2842,
    lng: 73.0305,
    label: "Village X, near Main Circle",
    ward: "Ward 14",
    district: "Ranchi",
  },
...
export const DISTRICT_SERIES = [
  { district: "Ranchi", count: 3210 },
  { district: "Bokaro", count: 1874 },
  { district: "Dhanbad", count: 1652 },
  { district: "Pakur", count: 1211 },
  { district: "Jamshedpur", count: 1087 },
  { district: "Giridih", count: 954 },
];
