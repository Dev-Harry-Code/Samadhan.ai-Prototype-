    ...
    >
      ...
      <div className="relative flex-shrink-0 w-16 h-16 flex justify-center">
        <button 
          ...
          className="absolute -top-5 w-14 h-14 bg-gradient-to-tr from-neon-purple via-neon-violet to-neon-fuchsia rounded-full flex items-center justify-center text-white shadow-neon-purple hover:scale-105 transition-transform fab-pulse z-10"
        >
